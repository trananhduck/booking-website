        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-2"><a href="#" class="text-muted text-decoration-none">Bảng giá</a></li>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                ...
                <ul class="list-unstyled">
                    <li class="mb-2"><a href="#" class="text-muted text-decoration-none">Page Grab Fan Tháng 9</a></li>
                    <li class="mb-2"><a href="#" class="text-muted text-decoration-none">Page Rap Fan Thám Thính</a>
                    </li>
                    <li class="mb-2"><a href="#" class="text-muted text-decoration-none">TikTok Grab Fan Tháng 9</a>
                    </li>
                    <li class="mb-2"><a href="#" class="text-muted text-decoration-none">Group Cộng đồng Grab Việt
                            Underground</a></li>
                </ul>
            </div>
        </div>
